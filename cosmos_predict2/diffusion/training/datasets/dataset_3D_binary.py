...
PYTHONPATH=. python cosmos_predict2/diffusion/posttrain/datasets/dataset_3D.py
...
from cosmos_predict2.diffusion.training.datasets.dataset_3D import Dataset_3D
