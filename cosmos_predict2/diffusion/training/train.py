...
from cosmos_predict2.diffusion.config.config import Config
...
from cosmos_predict2.utils.lazy_config.lazy import LazyConfig
from cosmos_predict2.utils.parallel_state_helper import is_tp_cp_pp_rank0
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        default="cosmos_predict2/diffusion/posttrain/config/config.py",
