...
from cosmos_predict2.diffusion.module.pretrained_vae import VideoTokenizerInterface
...
class Wan2pt1VAEInterface(VideoTokenizerInterface):
    def __init__(self, chunk_duration: int = 81, load_path: str = 'f"checkpoints/Wan-AI/Wan2.1-T2V-1.3B/Wan2.1_VAE.pth', **kwargs):
        self.model = WanVAE(
        ...
        self.load_weights(load_path, False)
