...
from cosmos_predict2.diffusion.training.module.blocks import (
    FinalLayer,
    Block,
    PatchEmbed,
    TimestepEmbedding,
...
from cosmos_predict2.diffusion.training.module.position_embedding import LearnablePosEmbAxis, VideoRopePosition3DEmb
from cosmos_predict2.utils import log


class GeneralDIT(WeightTrainingStat):
    """
