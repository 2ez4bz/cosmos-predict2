...
from cosmos_predict2.diffusion.networks.minimal_v1_lvg_dit import MinimalV1LVGDiT
...
COSMOS_PREDICT2_NET_V2W_14B_Config: LazyDict = L(MinimalV1LVGDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
...
COSMOS_PREDICT2_NET_V2W_2B_Config: LazyDict = L(MinimalV1LVGDiT)(
    max_img_h=240,
    max_img_w=240,
    max_frames=128,
    in_channels=16,
