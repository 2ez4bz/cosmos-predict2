...
Command:
    CUDA_HOME=$CONDA_PREFIX PYTHONPATH=$(pwd) python cosmos_predict2/diffusion/prompt_upsampler/text2world_prompt_upsampler_inference.py
...
from cosmos_predict2.autoregressive.configs.base.model_config import create_text_model_config
