...
def create_vlm_prompt_upsampler(checkpoint_dir: str) -> tuple[AutoProcessor, Qwen2_5_VLForConditionalGeneration]:
    ...
    model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
        checkpoint_dir, torch_dtype=torch.bfloat16, attn_implementation="flash_attention_2", device_map="cpu"
    )
...
def main(args):
    ...
    upsampled_prompt = run_chat_completion(processor, model, dialog)
